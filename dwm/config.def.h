...
static const char *fonts[]          = { "JetBrains Mono Nerd Font:size=12:style=Bold", "monospace:size=12" };
static const char dmenufont[]       = "JetBrains Mono Nerd Font:size=12:style=Bold";
